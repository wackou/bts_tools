...
SEED_NODES = {
    ...
    'muse': [
        ...
        ('104.199.148.218:33333',           '', 'wmuse.seoul',  ''),
    ...
    'steem': [
        ...
        ('seed.curiesteem.com:2001',         '',   'curie',          'http://curiesteem.com/'),
		...
		('anyx.io:2001',                     '',   'anyx',           'https://steemit.com/witness-category/@anyx/witness-application-anyx'),
		('steemseed.clayop.com:2001',        'us', 'clayop',         'https://steemit.com/witness-category/@clayop/witness-clayop'),
		('steem-seed.arcange.eu:2001',       'fr', 'arcange',        'https://steemit.com/witness-category/@arcange/arcange-witness-update-2019-01-27')
    ],
    'ppy': [
